...
services:
  ...
  riven-frontend:
    ...
    environment:
      ...
      - AUTH_SECRET=CHANGE_ME_32_CHARACTER_HEX_KEY
      - BETTER_AUTH_SECRET=CHANGE_ME_32_CHARACTER_HEX_KEY
      - BACKEND_API_KEY=IN_SETTINGS.JSON_FILE

    depends_on:
      riven:
        condition: service_healthy
    volumes:
      - ./riven-frontend/config:/riven/data
    networks:
      - riven-network
